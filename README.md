...
|-|-|-|-|
| `v3.4.0 < v4.0.0` | ![Compatibility for v3.4][v3.4] |  [![PyPI pyversions](https://img.shields.io/pypi/pyversions/aiida-quantumespresso.svg)](https://pypi.org/project/aiida-quantumespresso.svg) | 6.0, 6.1, 6.2, 6.3, 6.4, 6.5, 6.6, 6.7 |
| `v3.3.0 < v3.4.0` | ![Compatibility for v3.3][v3.3] |  [![PyPI pyversions](https://img.shields.io/pypi/pyversions/aiida-quantumespresso.svg)](https://pypi.org/project/aiida-quantumespresso.svg) | 6.0, 6.1, 6.2, 6.3, 6.4, 6.5, 6.6, 6.7 |
| `v3.1.0 < v3.3.0` | ![Compatibility for v3.1][v3.1] | 6.0, 6.1, 6.2, 6.3, 6.4, 6.5, 6.6, 6.7 |
| `v3.0.0 < v3.1.0` | ![Compatibility for v3.0][v3.0] | 6.0, 6.1, 6.2, 6.3, 6.4, 6.5, 6.6, 6.7 |
| `v2.0.0 < v3.0.0` | ![Compatibility for v2.0][v2.0] | 6.0, 6.1, 6.2, 6.3, 6.4, 6.5, 6.6, 6.7 |
