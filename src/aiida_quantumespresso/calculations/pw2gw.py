...
class Pw2gwCalculation(NamelistsCalculation):
    ...
    def define(cls, spec):
        ...
        spec.exit_code(305, 'ERROR_OUTPUT_FILES', message='The eps*.dat output files could not be read or parsed.')
        spec.exit_code(
            330,
    ...
    def prepare_for_submission(self, folder):
        ...
        calcinfo.remote_copy_list.append(
            (
                ...
                str(pathlib.Path(parent_calc_folder.get_remote_path()) / self._INPUT_PSEUDOFOLDER),
