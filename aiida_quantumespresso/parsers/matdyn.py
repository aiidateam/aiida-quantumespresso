...
class MatdynParser(Parser):
    ...
    def parse_with_retrieved(self, retrieved):
        ...
        if num_kpoints != this_num_kpoints:
            successful = False
            self.logger.error("Number of kpoints different in input and in " "phonon frequencies file")
        ...
        new_nodes_list = [(self.get_linkname_outparams(), output_params), (self.get_linkname_outbands(), output_bands)]
