...
from aiida_quantumespresso.parsers.raw_parser_pw import (read_xml_card, parse_xml_child_integer, xml_card_header,
                                                         parse_xml_child_bool, parse_xml_child_str,
                                                         parse_xml_child_float, parse_xml_child_attribute_str,
                                                         xml_card_cell, xml_card_ions, xml_card_exchangecorrelation,
...
def parse_cp_raw_output(out_file, xml_file=None, xml_counter_file=None):
    ...
    if xml_counter_file is not None:
        xml_counter_lines = xml_counter_file.read()
