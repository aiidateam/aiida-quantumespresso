...
class Pw2wannier90Calculation(NamelistsCalculation):
    ...
    def define(cls, spec):
        ...
        spec.input(
            'external_projectors_path', valid_type=RemoteData, required=False, help='Path to the external projectors.'
        )
        spec.input(
        ...
        spec.exit_code(340, 'ERROR_GENERIC_QE_ERROR', message='Encountered a generic error message')
        spec.exit_code(
