...
def parse_pw_xml_post_6_2(xml_file):
    ...
    xml_data = {
        ...
        'monkhorst_pack_offset': list(xml_dictionary['input']['k_points_IBZ']['monkhorst_pack'].values())[1:4],
        'monkhorst_pack_grid': list(xml_dictionary['input']['k_points_IBZ']['monkhorst_pack'].values())[4:7],
