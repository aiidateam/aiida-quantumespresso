...
def test_pp_default_1d(
    ...
    num_regression.check(
        data_dict={'data_array': data_array, 'coords_array': coords_array}, default_tolerance={'atol': 0, 'rtol': 1e-18}
    )
...
def test_pp_default_1d_spherical(
    ...
    num_regression.check(
        data_dict={'data_array': data_array, 'data_array_int': data_array_int, 'coords_array': coords_array},
...
def test_pp_default_3d(
    ...
    num_regression.check(
        data_dict={'data_array': data_array, 'voxel_array': voxel_array}, default_tolerance={'atol': 0, 'rtol': 1e-18}
    )
    data_regression.check(
        {
            'parameters': results['output_parameters'].get_dict(),
