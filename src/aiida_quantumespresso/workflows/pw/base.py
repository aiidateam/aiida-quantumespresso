...
class PwBaseWorkChain(ProtocolMixin, BaseRestartWorkChain):
    ...
    def define(cls, spec):
        ...
        spec.input('periodicity', valid_type=orm.Str, required=False, default=orm.Str('xyz'), help='Optional input for doing'
                'calculations where one dimension is of interest for Relax and Kpoint mesh. Valid options x , xy and xyz')
