...
class Q2rCalculation(NamelistsCalculation):
    ...
    def _init_internal_params(self):
        ...
        self._INPUT_SUBFOLDER = os.path.join('.', PhCalculation._FOLDER_DYNAMICAL_MATRIX)
        ...
        self._retrieve_singlefile_list = [[
            self.get_linkname_force_matrix(), 'quantumespresso.forceconstants', self._FORCE_CONSTANTS_NAME
        ]]
