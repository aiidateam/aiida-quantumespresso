...
def test_command_base(run_cli_process_launch_command, fixture_code, pseudo_family, generate_structure):
    ...
    options = ['-X', code.full_label, '-F', pseudo_family.label, '-s'] + structures
